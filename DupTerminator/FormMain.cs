...
namespace DupTerminator
{
    internal partial class FormMain : BaseForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //耦猁蜩?恹琨忄邈?+= new 溴脲汔?恹琨忄邈?耦猁栩?镳桧桁帼泐)
        ...
        private void Load_ListDuplicate(string directory)
        {
            ...
            if (System.IO.File.Exists(fileName))
            {
                try
                {
                    ...
                    AllowListChkUpdate = false; // 桧圜?狍溴?玎矬耜囹 lvDuplicates_ItemChecked
        ...
        private void FileUpdateEventHandler(string fileName, int currentCount)
        {
            ...
            SomeCodeToTime();
            timer.Stop();
            Console.WriteLine("蔓镱腠屙桢 戾蝾溧 玎?腩 {0} 祚", timer.ElapsedMilliseconds);*/
        }
        ...
        /// <param name="ClearSelected">西桉蜩螯 铗钺疣驽龛?恹狃囗睇?玎镨皴?/param>
        ...
        /// <summary>
        /// 暑眚尻耱眍?戾睨 潴犭桕囹钼 - 蔓狃囹?怦??铋 镟镪?(?沭箫镟??桁?镟镪囔?
        /// </summary>
        private void tmsi_Dubli_SelectAllInThisFolderinGroupWithThisFolder_Click(object sender, EventArgs e)
        {
            if (lvDuplicates.FocusedItem != null && lvDuplicates.FocusedItem.Group != null)
            {
                ...
                //镳钼屦屐 赅驿簋 沭箫矬 磬 磬腓麒?卵耪 玎镨皴?桤 桉觐祛?
                foreach (ListViewGroup group in lvDuplicates.Groups)
                {
        ...
        /// <summary>
        /// 暑眚尻耱眍?戾睨 潴犭桕囹钼 - 愉嚯栩?铗耋蝰蜮簋?羿殡?桤 耧桉赅
        /// </summary>
        ...
        /// <summary>
        /// 暑眚尻耱眍?戾睨 潴犭桕囹钼 - 襄疱桁屙钼囹?羿殡 赅?耦皴漤栝
        /// </summary>
        ...
        /// <summary>
        /// 暑眚尻耱眍?戾睨 潴犭桕囹钼 - 襄疱戾耱栩?恹狃囗睇?羿殡??镟镪?
        /// </summary>
        ...
        private void lvDuplicates_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            for(int i = 0; i<lvDuplicates.Groups.Count;i++)
            {
                ...
                foreach (ListViewItem item in lvDuplicates.Groups[i].Items)
                {
                    ...
                    //lvDuplicates.Items.Remove(item); //戾潆屙眍
        ...
        /// <summary>
        /// 橡钼屦赅 羼螯 腓 ?桁屙?羿殡?麒耠?铗溴脲眄铄 "_". 骂玮疣弪 麒耠?
        /// </summary>
        /// <param name="name">桁 羿殡?/param>
        /// <param name="digname">桁 羿殡?徨?麒耠??"_"</param>
        /// <returns>0 桦?麒耠?镱塍麇眄铄</returns>
        ...
        /// <summary>
        /// 念徉怆屙桢 ?桁屙?羿殡?麒耠??耠篦噱 觐沅??礤?邈?礤 猁腩
        /// </summary>
        /// <param name="oldname">羊囵铄 桁</param>
        /// <param name="i">阻耠?/param>
        /// <returns>皖忸?桁</returns>
        ...
        /// <summary>
        ///  念徉怆屙桢 ?桁屙?羿殡?麒耠??耠篦噱 觐沅??礤?猁腩 麒耠? ?腓滂痼桁?眢?扈
        /// </summary>
        /// <param name="oldname">羊囵铄 桁</param>
        /// <param name="zero">暑腓麇耱忸 腓滂痼桴 眢脲?/param>
        /// <param name="i">阻耠?/param>
        /// <param name="ext">朽聒桊屙桢 羿殡?/param>
        /// <param name="sourceName">锐躅漤铄 桁</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 襄疱忸滂?麒耠钼铄 镳邃耱噔脲龛?疣珈屦??铌痼汶屙眍???耦铗忮蝰蜮簋?蝈犟蝾?邃桧桷?桤戾疱龛
        /// </summary>
        /// <param name="size">朽珈屦</param>
        /// <param name="sbytes">配屙桷?桤戾疱龛</param>
        ...
        /// <summary>
        /// 暑眚尻耱眍?戾睨 潴犭桕囹钼 - 蔓狃囹?镱 溧蝈 - 羊囵 羿殡 ?赅驿铋 沭箫镥
        /// </summary>
        ...
        /// <summary>
        /// 暑眚尻耱眍?戾睨 潴犭桕囹钼 - 蔓狃囹?镱 溧蝈 - 皖恹?羿殡 ?赅驿铋 沭箫镥
        /// </summary>
